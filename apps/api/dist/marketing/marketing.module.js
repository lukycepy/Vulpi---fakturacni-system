...
exports.MarketingModule = MarketingModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, communication_module_1.CommunicationModule],
        controllers: [marketing_controller_1.MarketingController],
        providers: [marketing_service_1.MarketingService, retention_service_1.RetentionService],
