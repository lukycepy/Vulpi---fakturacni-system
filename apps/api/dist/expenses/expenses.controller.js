...
let ExpensesController = class ExpensesController {
    ...
    ocrService;
    cashflowService;
    constructor(expensesService, ocrService, cashflowService) {
    ...
    async getCashflow(organizationId) {
...
], ExpensesController.prototype, "analyze", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ExpensesController.prototype, "getCashflow", null);
exports.ExpensesController = ExpensesController = __decorate([
    (0, common_1.Controller)('expenses'),
    __metadata("design:paramtypes", [expenses_service_1.ExpensesService,
        ocr_service_1.OcrService,
        cashflow_service_1.CashflowService])
], ExpensesController);
